...
trained_weights <- createSignature(train_dataset_config_path, signature_name, feature_type="deep_learning", output_dir = output_dir, overwrite_signature = TRUE, test_signature = TRUE, k=2)
